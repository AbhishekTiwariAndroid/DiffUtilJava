...
import dev.abhishektiwari.diffjava.apputil.MyDiffUtilCallbacks;
...
public class HomeRecyclerAdapter extends RecyclerView.Adapter<HomeRecyclerAdapter.MyViewHolder> {
    ...
    public void updateContacts(ArrayList<Contact> newContacts){
        ...
        DiffUtil.DiffResult diffResult = DiffUtil.calculateDiff(new MyDiffUtilCallbacks(contacts,newContacts));
